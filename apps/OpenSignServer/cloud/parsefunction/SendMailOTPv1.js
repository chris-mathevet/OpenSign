    ...
    if (email) {
      ...
      try {
        await Parse.Cloud.sendEmail({
          ...
          recipient: recipient,
          subject: `Votre OTP ${AppName}`,
          text: 'otp email',
          html:
            `<html><head><meta http-equiv='Content-Type' content='text/html;charset=UTF-8' /></head><body><div style='background-color:#f5f5f5;padding:20px'><div style='background-color:white;'><div style='background-color:red;padding:2px;font-family:system-ui;background-color:#29A9D8;'><p style='font-size:20px;font-weight:400;color:white;padding-left:20px;'>Vérification OTP</p></div><div style='padding:20px;'><p style='font-family:system-ui;font-size:14px;'>Votre OTP pour vérification ${AppName} est :</p><p style='text-decoration:none;font-weight:bolder;color:blue;font-size:45px;margin:20px;'>` +
            code +
