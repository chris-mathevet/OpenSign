...
export const defaultMailBody = `<p>Bonjour {{receiver_name}},</p><br><p>Nous espérons que vous allez bien. {{sender_name}}&nbsp;vous a demandé de consulter et de signer&nbsp;{{document_title}}.</p><p>Votre signature est essentielle pour passer aux étapes suivantes, car elle confirme votre accord et votre autorisation.</p><br><p><a href='{{signing_url}}' rel='noopener noreferrer' target='_blank'>Signez ici</a></p><br><br><p>Si vous avez des questions ou besoin de précisions supplémentaires concernant le document ou le processus de signature, veuillez contacter l’expéditeur.</p><br><p>Merci</p><p> Équipe ${appName}</p><br>`;
export const defaultMailSubject = `{{sender_name}} vous a demandé de signer {{document_title}}`;
...
export const mailTemplate = (param) => {
  ...
  const subject = `${param.senderName} vous a demandé de signer  "${param.title}"`;
  const body =
    ...
    logo +
    `<div style='padding:2px;font-family:system-ui;background-color:${themeColor}'><p style='font-size:20px;font-weight:400;color:white;padding-left:20px'>Demande de signature électronique</p></div><div><p style='padding:20px;font-size:14px;margin-bottom:10px'>` +
    param.senderName +
    " vous a demandé de consulter et de signer <strong>" +
    param.title +
    "</strong>.</p><div style='padding: 5px 0px 5px 25px;display:flex;flex-direction:row;justify-content:space-around'><table><tr><td style='font-weight:bold;font-family:sans-serif;font-size:15px'>Expéditeur</td><td></td><td style='color:#626363;font-weight:bold'>" +
    param.senderMail +
    "</td></tr><tr><td style='font-weight:bold;font-family:sans-serif;font-size:15px'>Organisation</td><td></td><td style='color:#626363;font-weight:bold'> " +
    param.organization +
    "</td></tr><tr><td style='font-weight:bold;font-family:sans-serif;font-size:15px'>Date d'expiration</td><td></td><td style='color:#626363;font-weight:bold'>" +
    ...
    param.signingUrl +
    "><button style='padding:12px;background-color:#d46b0f;color:white;border:0px;font-weight:bold;margin-top:30px'>Signer ici</button></a></div><div style='display:flex;justify-content:center;margin-top:10px'></div></div></div><div><p> Ceci est un courriel automatique envoyé par " +
    appName +
    ". Pour toute question concernant cet courriel, veuillez contacter directement l'expéditeur à l'adresse " +
    param.senderMail +
    ".</p></div></div></body></html> ";
  return { subject, body };
};
